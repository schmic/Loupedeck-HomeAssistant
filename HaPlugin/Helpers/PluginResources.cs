namespace Loupedeck.HaPlugin.Helpers
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HaPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HaPlugin.Resources.Resource.txt`.
